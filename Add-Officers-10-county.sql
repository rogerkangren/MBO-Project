...
set @newOfficer_State = 'Alabama'--nvarchar(50)  --Alabama Arizona California Colorado Florida New Mexico Texas
...
set @newOfficer_County4 = 'Marshall'--nvarchar(50)
set @newOfficer_County5 = ''--nvarchar(50)
set @newOfficer_County6 = ''--nvarchar(50)
set @newOfficer_County7 = ''--nvarchar(50)
set @newOfficer_County8 = ''--nvarchar(50)
set @newOfficer_County9 = ''--nvarchar(50)
set @newOfficer_County10 = '' --nvarchar(50)
set @newOfficer_street_address = '114 Governors Dr. SE 2nd FL, Huntsville, AL 35801' --nvarchar(max)
set @newOfficer_office_phone_number = '256-532-6273' --nvarchar(50)
set @newOfficer_cell_phone_number = '' --nvarchar(50)
set @newOfficer_fax_number = '205-524-0447' --nvarchar(50)
set @newOfficer_site_effective_date = '4/25/2016' --datetime
set @newOfficer_nmls_originator_id = '534943' --int
set @newOfficer_email_address = 'chad.montgomery@bbva.com' --nvarchar(50)
set @newOfficer_main_url = 'mortgage.bbvacompass.com/default.asp?siteId=7BA3E584-8A29-4218-9241-7B10307C430C' --nvarchar(max)
set @newOfficer_alias_url = 'http://www.bbvacompass.com/mortgages/cmontgomery' --nvarchar(max)
